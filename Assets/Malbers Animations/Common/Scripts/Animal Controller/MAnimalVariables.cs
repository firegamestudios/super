...
namespace MalbersAnimations.Controller
{
    ...
    public partial class MAnimal
    {
       ...
       // private bool HasReachedMaxSlope;
        public BoolEvent OnInputLocked = new();          //Used for Sync Animators
        public BoolEvent OnMovementLocked = new();        //Used for Sync Animators
        public BoolEvent OnSprintEnabled = new();       //Used for Sync Animators
        public BoolEvent OnGrounded = new();       //Used for Sync Animators
        public BoolEvent OnMovementDetected = new();       //Used for Sync Animators
