...
namespace MalbersAnimations.Controller
{
    ...
    public class Combo
    {
        ...
        public bool Play(ComboManager M)
        {
            ...
            //Debug.Log($"animal.ActiveMode != CachedMode {CachedMode.Name}");
            ...
            else //if (animal.ActiveMode == CachedMode) 
            {
                ...
                if (Sequence[ActiveSequenceIndex].Finisher)
                {
                    ...
                    if (Sequence[ActiveSequenceIndex].Restarter && Sequence[ActiveSequenceIndex].Activation.IsInRange(animal.ModeTime))
                    {
