    ...
    public class PunCharacterTransformMonitor : MonoBehaviour, IPunObservable
    {
        ...
        private void Update()
        {
            ...
            if (m_CharacterLocomotion.MovingPlatform != null) {
                ...
                m_CharacterLocomotion.SetPositionAndRotation(m_CharacterLocomotion.MovingPlatform.TransformPoint(m_NetworkPlatformPrevRelativePosition), MathUtility.TransformQuaternion(m_CharacterLocomotion.MovingPlatform.rotation, m_NetworkPlatformPrevRotationOffset), false, false);
            } else {
#if ULTIMATE_CHARACTER_CONTROLLER_MULTIPLAYER
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
        {
            if (stream.IsWriting) {
                ...
                if (m_CharacterLocomotion.MovingPlatform != null) {
                    ...
                    var position = m_CharacterLocomotion.MovingPlatform.InverseTransformPoint(m_Transform.position);
