...
namespace Opsive.UltimateCharacterController.AddOns.Multiplayer.PhotonPun.Utility
{
    ...
    public static class PunUtility
    {
        ...
        public static (uint ID, bool HasID) GetID(GameObject gameObject, out int itemSlotID)
        {
            itemSlotID = -1;
            if (gameObject == null) {
                return (0, false);
        ...
        public static GameObject RetrieveGameObject(GameObject parent, uint id, int itemSlotID)
        {
            ...
            if (itemSlotID == -1) {
                ...
                if (!idObjectIDMap.TryGetValue(id, out var objectIdentifier) || (objectIdentifier == null && idObjectIDMap.ContainsKey(id))) {
                ...
                var itemIdentifier = Networking.Game.ItemIdentifierTracker.GetItemIdentifier(id);
